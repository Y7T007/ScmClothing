...
@WebServlet("/store_jacket")
public class store_jacket extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
         ...
         // Retrieve the products from the database
            ...
            String sql = "SELECT * FROM ARTICLES where categorie = 'vestes'";
         ...
         // set the number of divs to generate
            ...
            request.getRequestDispatcher("/store_jacket.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
